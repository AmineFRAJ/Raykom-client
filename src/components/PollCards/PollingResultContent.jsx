...
const PollOptionVoteResult = ({ label, optionVotes, totalVotes }) => {
  ...
  return (
    <div className="w-full bg-green-200/60 rounded-md h-6 relative mb-3">
      <div
        className="bg-green-900/10 h-6 rounded-md"
...
const ImagePollResult = ({ imgUrl, optionVotes, totalVotes }) => {
  return (
    <div>
      <div className="w-full bg-green-200 felx items-center gap-2 mb-4 rounded-md overflow-hidden">
      ...
      <div className="flex gap-3">
        {profileImgUrl ? (
          ...
          <CharAvatar
            ...
            style="w-8 h-8 text-[10px] bg-green-800/40"
          />
        )}
